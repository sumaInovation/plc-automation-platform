        ...
        <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-4">
                ...
                href="https://web.facebook.com/profile.php?id=61584817932640"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="text-[#DDDDDD] hover:text-white transition-colors"
              >
              ...
              >
                ...
                href="https://www.youtube.com/channel/UC6clav6PfiYBL0YGEfhqhpQ"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="text-[#DDDDDD] hover:text-white transition-colors"
